...
enum custom_keycodes
{
    ...
    MSE_A      = LT(_MOUSE, KC_A),    // mod-tap: tap='a', hold=Mouse layer
...
const uint16_t PROGMEM l_esc_combo[] = {KC_W,    KC_F,       COMBO_END};
const uint16_t PROGMEM r_esc_combo[] = {KC_U,    KC_Y,       COMBO_END};
const uint16_t PROGMEM bspc_combo[]  = {KC_F,    KC_P,       COMBO_END};
const uint16_t PROGMEM del_combo[]   = {KC_L,    KC_U,       COMBO_END};
const uint16_t PROGMEM l_ent_combo[] = {KC_C,    KC_D,       COMBO_END};
const uint16_t PROGMEM r_ent_combo[] = {KC_H,    KC_COMM,    COMBO_END};
const uint16_t PROGMEM circ_combo[]  = {KC_X,    KC_C,       COMBO_END};
const uint16_t PROGMEM trema_combo[] = {KC_COMM, KC_DOT,     COMBO_END};
const uint16_t PROGMEM cc_combo[]    = {KC_K,    KC_C,       COMBO_END};
const uint16_t PROGMEM altf4_combo[] = {KC_Q,    KC_P, KC_V, COMBO_END};
...
{
    // basic keycodes
    [L_BSPC]   = COMBO(bspc_combo,     KC_BSPC),
    [L_ESC]    = COMBO(l_esc_combo,    KC_ESC),
    [L_ENT]    = COMBO(l_ent_combo,    KC_ENT),
    [R_ESC]    = COMBO(r_esc_combo,    KC_ESC),
    [R_DEL]    = COMBO(del_combo,      KC_DEL),
    [R_ENT]    = COMBO(r_ent_combo,    KC_ENT),
    [CIRC]     = COMBO(circ_combo,     KC_CIRC),
    [TREMA]    = COMBO(trema_combo,    S(KC_QUOT)),
    [C_CED]    = COMBO(cc_combo,       RALT(KC_COMM)),
    // special actions
    [QPV_QUIT] = COMBO_ACTION(altf4_combo),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_DEF_LAYER] = LAYOUT(
        ...
        MSE_A,    KC_ALTR,       KC_LSHS,       KC_CTLT,       KC_G,        KC_M,          KC_CTLN,         KC_LSHE,         KC_ALTI,        MSE_O,
        KC_GUIZ,  KC_X,          KC_C,          KC_D,          KC_V,        KC_K,          KC_H,            KC_COMM,         KC_DOT,         KC_QUOT,
                  KC_NO,         KC_V,          KC_NO,                                     KC_NO,           KC_K,            KC_NO, 
                                 KC_NO,         KC_SPACE,      LOWER_TAB,   RAISE_BSPC,    OSM(MOD_LSFT),   KC_NO
  ),

    // Lower layer: num pad, symbols, navigation, {}
    [_LOWER] = LAYOUT(
        KC_MINS,  KC_7,          KC_8,          KC_9,          KC_EQL,      ND_CIRC,       KC_CIRC,         KC_PIPE,         KC_SLSH,        KC_UNDS,
        GUI_PLUS, LALT_T(KC_4),  LSFT_T(KC_5),  LCTL_T(KC_6),  KC_ASTR,     S(RALT(KC_4)), CTL_LTHN,        LSFT_T(KC_EQL),  ALT_GTHN,       KC_RAMN,
        KC_SLSH,  KC_1,          KC_2,          KC_3,          KC_DOT,      KC_NO,         KC_LCBR,         KC_CIRC,         KC_RCBR,        S(KC_QUOT),
                  KC_NO,         KC_0,          KC_NO,                                     KC_NO,           KC_SCLN,         KC_NO, 
    ...
    [_RAISE] = LAYOUT(
        ...
        GUI_COLN, KC_ASTR,       KC_YEN,        KC_GBP,        ND_GRV,      KC_COLN,       KC_LPRN,         KC_DOWN,         KC_RPRN,        S(KC_QUOT),
                  KC_NO,         KC_DEGR,       KC_NO,                                     KC_NO,           KC_SCLN,         KC_NO,
                                 KC_TRNS,       KC_TRNS,       KC_TRNS,     KC_TRNS,       KC_TRNS,         KC_TRNS
    ),

    // adjust layer: function keys, navigation, []
    [_ADJUST] = LAYOUT(
        KC_PAUS,  KC_F7,         KC_F8,         KC_F9,         KC_VOLU,     KC_MNXT,       KC_F10,          KC_F11,          KC_F12,         KC_L,
        KC_PSCR,  LALT_T(KC_F4), LSFT_T(KC_F5), LCTL_T(KC_F6), KC_VOLD,     KC_MPRV,       LCTL_T(KC_HOME), LSFT_T(KC_PGUP), LALT_T(KC_END), KC_RAMN,
        GUI_INS,  KC_F1,         KC_F2,         KC_F3,         KC_MUTE,     KC_MPLY,       KC_LBRC,         KC_PGDN,         KC_RBRC,        S(KC_QUOT),
                  KC_NO,         KC_DEGR,       KC_NO,                                     KC_NO,           KC_SCLN,         KC_NO,
                                 KC_TRNS,       KC_TRNS,       KC_TRNS,     KC_TRNS,       KC_TRNS,         KC_TRNS
    ),
